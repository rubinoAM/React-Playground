...
function (_Component) {
  ...
  function Button() {
    ...
    _defineProperty(_assertThisInitialized(_this), "computeElementType", function () {
      ...
      if (!_lodash.default.isNil(attached) || !_lodash.default.isNil(label)) return 'div';
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "focus", function () {
      return _lodash.default.invoke(_this.ref.current, 'focus');
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function (e) {
      ...
      _lodash.default.invoke(_this.props, 'onClick', e, _this.props);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "hasIconClass", function () {
      ...
      return icon && (labelPosition || _lib.childrenUtils.isNil(children) && _lodash.default.isNil(content));
    });
  ...
  _createClass(Button, [{
    ...
    value: function computeButtonAriaRole(ElementType) {
      ...
      if (!_lodash.default.isNil(role)) return role;
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Ref.default, {
        innerRef: this.ref
      }, _react.default.createElement(ElementType, _extends({}, rest, {
        className: classes,
        "aria-pressed": toggle ? !!active : undefined,
...
_defineProperty(Button, "propTypes", {
  ...
  color: _propTypes.default.oneOf([].concat(_toConsumableArray(_lib.SUI.COLORS), ['facebook', 'google plus', 'instagram', 'linkedin', 'twitter', 'vk', 'youtube'])),
